...
const arkhamHorror = new GameModel({ name: 'Arkham Horror', rating: 8, genre: "Horror, Adventure, Roleplaying", gameType: "Co-op", players: "1 - 8", picture: "***", timesPlayed: "0", averagePlayTime: 150, thoughts: "Madcap fun if everyone works together. Otherwise you all get murdered by fish cultists.", theHype: "Work togetehr to defeat the monsters in time or an Elder God will consume your reality."});
